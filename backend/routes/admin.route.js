...
import { addDoctor, appointmentsAdmin, cancelAppointments, getDashboardData, getDoctor, loginAdmin, updatePayment } from '../controllers/admin.controller.js';
...
adminRouter.post('/update-payment',authAdmin,updatePayment);
